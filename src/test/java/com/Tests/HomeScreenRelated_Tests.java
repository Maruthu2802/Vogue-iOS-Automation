...
//    @Test(priority = 14, description = "VD_TC_448 - Verify when start play the game the quizz slide have slide count on the top of the screen eg.1/20")
    ...
    @FrameworkAnnotation(author = "Shivumuni", category = {CategoryType.SMOKE})
//    @Test(priority = 15, description = "VD_TC_455 - Verify when user is in quizz screen and middle of the quizz press back arrow user should able to go back with out asking the confirmation message.")
...
//    @Test(priority = 16, description = "VD_TC_453_456_438_410_437_422_425_426_427_428_429_518 - Verify user can able to play all the question one after another till the last slide of the question and SHARE page")
    public void verifyPlayingQuizAndShareOptionsAndQuizResultsPageAndDifficultyLevel() {
        landingAndSignInScreen.signInFlow(Credentials.subscribedUsername, Credentials.subscribedPassword);
        homeScreen.validatePlayingQuiz();                                         //VD_TC_453, VD_TC_456
        homeScreen.validateShareOptions();                                              //VD_TC_438, VD_TC_410
